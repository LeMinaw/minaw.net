...
class Publication(models.Model):
    ...
    cover    = models.ForeignKey('Cover', null=True, blank=True, verbose_name="couverture")
    ...
    categ    = models.ForeignKey('Category', null=True, verbose_name="catégorie")
...
class Comment(models.Model):
    ...
    publi   = models.ForeignKey('Publication', verbose_name="publication")
