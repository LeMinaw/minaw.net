...
function base(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function h(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
...
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=function(a,c){if("undefined"==typeof a||null!=a&&a.hasOwnProperty("__kwargtrans__"))a=null;if("undefined"==typeof c||null!=c&&c.hasOwnProperty("__kwargtrans__"))c=200;window.history.back();null!==a&&setTimeout(function(){window.location.href=a},c)};c.__name__="__main__";c.go_back=a;c.start=function(){window.addEventListener("click",function(b){document.getElementById("work").contains(b.target)||a("/")});window.addEventListener("keypress",function(b){"Escape"==
b.key&&a("/")})}})();return c}window.base=base();

//# sourceMappingURL=extra/sourcemap/base.min.js.map
